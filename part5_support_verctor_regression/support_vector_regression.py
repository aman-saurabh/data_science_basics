...
# regression. So feature scaling is not performed implicitely in the model and 
...
# Step5 - Fitting Support vector Regression to the dataset
...
# Step6 - Visualizing the support vector regression result
