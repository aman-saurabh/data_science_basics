...
# Step6 - Fitting Decision Tree Classifier to the Training Set
from sklearn.tree import DecisionTreeClassifier
classifier = DecisionTreeClassifier(criterion='entropy', random_state=0)
# default value for criterion is 'gini'.But most of the time we will use 
# 'entropy' as criterion.So don't rely on default value and change it manually.
